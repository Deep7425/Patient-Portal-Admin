...
class UsersSubscriptions extends Authenticatable
{
     ...
     * @var string
     */
     protected $fillable = ['user_id', 'login_id' , 'name' , 'order_id','payment_mode','coupon_id','coupon_discount','tax','order_subtotal','order_total','order_status','ref_code','hg_miniApp','meta_data','added_by','remark','organization_id','order_from','subcribedate','created_at'];
