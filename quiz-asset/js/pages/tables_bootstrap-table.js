  ...
  $table.bootstrapTable({
    ...
    detailFormatter: function detailFormatter(index, row) {
      ...
      $.each(row, function (key, value) {
		  if(key == 'negative_effect'){
			  html.push('<p><b>Negative Affect :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
		  if(key == 'detechment') {
			  html.push('<p><b>Detachment :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
		  if(key == 'antagonism'){
			  html.push('<p><b>Antagonism :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
		  if(key == 'disinhibition'){
			  html.push('<p><b>Disinhibition :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
		  if(key == 'psychoticism'){
			  html.push('<p><b>Psychoticism :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
		  if(key == 'finalTotalScore'){
			  html.push('<p><b>Total Score :</b> ' + (typeof value === 'undefined' ? false : value) + '</p>');
		  }
      });
    ...
    columns: [
      [
		...
		, {
          title: 'Personality Trait Domain Scoring',
          colspan: 6,
          align: 'center'
        }
      ],
      [
		...
		{
          field: 'negative_effect',
          title: 'Negative Affect',
          sortable: true,
          editable: true,
          footerFormatter: function totalNegativeEffectFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.negative_effect;
            });
        ...
        },
		{
          ...
          sortable: true,
          editable: true,
           footerFormatter: function totalDetechmentFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.detechment;
            });
        ...
        },
		{
          ...
          sortable: true,
          editable: true,
          footerFormatter: function totalAntagonismFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.antagonism;
            });
        ...
        },
		{
          ...
          sortable: true,
          editable: true,
          footerFormatter: function totalDisinhibitionFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.disinhibition;
            });
		...
		{  field: 'psychoticism',
          ...
          sortable: true,
          editable: true,
          footerFormatter: function totalPsychoticismFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.psychoticism;
            });
		...
		{  field: 'finalTotalScore',
          title: 'Total Score',
          sortable: true,
          editable: true,
          footerFormatter: function totalFinalTotalScoreFormatter(data) {
            var total = 0;

            $.each(data, function (i, row) {
              total += row.finalTotalScore;
            });
