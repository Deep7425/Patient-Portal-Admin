...
@elseif($controller == "LabController")
	@php $title = 'Book Diagnostic Tests for Preventive Care';
		 $description = 'Book diagnostic tests to take health care package listed in your prescription at pocket-friendly prices.';
	@endphp
	<title>{{trim($title)}}</title>
	<meta name="description" content="@if($description){{@$description}}@else @yield('description') @endif"/>
	<meta property="og:description" content="@if($description){{@$description}}@else @yield('description') @endif"/>
...
@endif
	...
	<link rel="stylesheet" href="/patient_portal_live/css/style.css" type="text/css" media="all"  />

	<link rel="stylesheet" href="/patient_portal_live/css/common.css" type="text/css" media="all" />
...
<!--
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@200;300;500;600;800;900&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Yantramanav:wght@300;400;500;700&display=swap" rel="stylesheet">-->
   	


	<link rel="preload" as="style" href="/patient_portal_live/css/carouselMin.css" media="all" defer async onload="this.onload=null;this.rel='stylesheet'" />
	<noscript><link rel="stylesheet" href="/patient_portal_live/css/carouselMin.css"></noscript>
	<link rel="preload" as="style" href="/patient_portal_live/css/themeMin.css" media="all" defer async  onload="this.onload=null;this.rel='stylesheet'"/>
	<noscript><link rel="stylesheet" href="/patient_portal_live/css/themeMin.css"></noscript>
    <link rel="preload" as="style" href="/patient_portal_live/css/materialize.css" media="all" defer async onload="this.onload=null;this.rel='stylesheet'"/>
	<noscript><link rel="stylesheet" href="/patient_portal_live/css/materialize.css"></noscript>
	<link rel="preload" as="style" href="/patient_portal_live/css/font-face-sidebar.css" type="text/css" media="all" async defer onload="this.onload=null;this.rel='stylesheet'"/>
	<noscript><link rel="stylesheet" href="/patient_portal_live/css/font-face-sidebar.css"></noscript>
	<script src="/patient_portal_live/css/assets/plugins/jQuery/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="/patient_portal_live/css/assets/plugins/jquery-ui-1.12.1/jquery-ui.min.js" type="text/javascript" defer></script>
	<script src="/patient_portal_live/css/assets/plugins/jquery.ui.touch-punch.min.js" type="text/javascript" defer></script>
    ...
    <script src="/patient_portal_live/js/jquery.validate.min.js" type="text/javascript"></script>
    <link rel="preload" as="style" href="/patient_portal_live/css/select2.min.css" type="text/css" media="all" defer async onload="this.onload=null;this.rel='stylesheet'"/>
	<noscript><link rel="stylesheet" href="/patient_portal_live/css/select2.min.css"></noscript>
	<script src="/patient_portal_live/js/select2.min.js" type="text/javascript"></script>
