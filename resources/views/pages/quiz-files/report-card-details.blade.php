        ...
        <div class="layout-inner">
            ...
            <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-dark">
                ...
                <div class="app-brand demo">
                    ...
                    <a href="{{url("/")}}/assessment-admin/{{$slug}}" class="app-brand-text demo sidenav-text font-weight-normal ml-2">Health Gennie</a>
                    ...
                    <li class="sidenav-item open active">
                        ...
                        <ul class="sidenav-menu">
                            <li class="sidenav-item">
                                <a href="{{url("/")}}/assessment-admin/{{$slug}}" class="sidenav-link">
                                    <div>Home</div>
                                </a>
                            </li>
							<li class="sidenav-item active">
                                <a href="{{url("/")}}/assessment-list/{{$slug}}" class="sidenav-link">
                                    <div>List</div>
                                </a>
                            </li>
							<li class="sidenav-item">
                                <a href="{{url("/")}}/programme/{{$slug}}" class="sidenav-link">
                                    <div>Programme</div>
                                </a>
                            </li>

                            <!-- <li class="sidenav-item">
                                <a href="{{url("/")}}/report-card/{{$slug}}" class="sidenav-link">
                                    <div>Report Card</div>
                                </a>
                            </li> -->
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <!--<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                         ...
                         <!-- <div id="bootstrap-table-toolbar">
						 	...
						 	<div class="row">
                             <form id="reportcard" action="{{url('report-card')}}">
                             <div class="form-field">
                                                <label for="cars">Search By Status:</label>
                                                <select id="assesment" class="status" name="status">
                                                <option value="">Select</option>
                                                    <option value="1" @if((app('request')->input('status'))!='') @if(app('request')->input('status') == '1') selected @endif @endif>Completed</option>
                                                    <option value="0" @if((app('request')->input('status'))!='') @if(app('request')->input('status') == '0') selected @endif @endif>Pending</option>
