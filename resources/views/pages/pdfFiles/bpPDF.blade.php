  ...
  <body style="font-family: 'Open Sans', sans-serif !important;">
  	<table cellpadding="0" cellspacing="0" style="width: 730px;">
  		...
  		<tbody>
  							...
  							<tr>
  								<td colspan="4" style="text-align:center; color: #189ad4; font-size:24px; padding: 5px 10px;">BP Details </td>
  							</tr>
  							<tr>
  								<td style="border: 1px solid #ccc; font-size: 16px; color: #189ad4; padding: 5px 10px;">BP SYS/DIAS</td>
  								<td style="border: 1px solid #ccc; font-size: 16px; color: #189ad4; padding: 5px 10px;">Pulse Rate</td>
