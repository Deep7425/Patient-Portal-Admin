            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Health Counceling Dashboard</h4>
                                        ...
                                        <div class="card mb-4 cardtop">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="">
                                                    	<span class="badge badge-primary">Total Couceling</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-4 cardtop">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="">
                                                    	<span class="badge badge-success">All Pending Couceling</span>
                                                        <h2 class="mb-2">{{$totalAssessmentPending}}</h2>
                                                        <p class="text-muted mb-0"> </p>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-4 cardtop">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="">
                                                    	<span class="badge badge-danger">Today Couceling</span>
