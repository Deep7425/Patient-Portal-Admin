...
return [
    ...
    */
    ...
    'gateway' => 'Paytm',                // Replace with the name of default gateway you want to use
    ...
    'paytm' =>  [
        'env' => 'production',
		'MERCHANT_KEY' => 'RIs6SppkRxARPR4Y',
		'MID' => 'fiBzPH32318843731373',
		'CHANNEL_ID' => 'WEB',
		'WEBSITE' => 'WEBSTAGING',
		'INDUSTRY_TYPE_ID' => 'Retail',
		'REDIRECT_URL' => 'indipay/paytmresponse',
    ],

    // Add your response link here. In Laravel 5.2+ you may use the VerifyCsrf Middleware.
    'remove_csrf_check' => [
        'paytmresponse','paymentresponse','paymentcancel'
    ],
